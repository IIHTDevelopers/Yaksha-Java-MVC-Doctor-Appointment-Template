...
<body>
		...
		<table>
			<tbody>
				...
				<tr>
					...
					<td><form:input path="appointmentDate" type = "date" /></td>
				</tr>
				<tr>
					<td><label> Appointment Time (HH:mm:ss):</label></td>
					<td><form:input path="appointmentTime" type = "time"/></td>
				</tr>
				<tr>
					<td><label></label></td>
	...
	<br><br>
	<div id="container">
			<a href="${pageContext.request.contextPath}/appointment/list">Back to List Page</a>
	</div>
